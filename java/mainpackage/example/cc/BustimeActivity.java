...
public class BustimeActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Button gosubwayBtn = (Button) findViewById(R.id.gosubway);
        gosubwayBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), BustimeGoSchoolActivity.class);
                startActivity(intent);
            }
        });
